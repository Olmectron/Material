 ...
 * @author Édgar
 */
public class MaterialTextField extends VBox implements MaterialComponent {
  ...
  private Point2D findScreenLocation(Node node) {
    ...
    public MaterialTextField(String texto, String label){
        super();
    ...
    private ArrayList<String> matchesArray=new ArrayList<String>();
     final ObjectProperty<String> warningColor = new SimpleObjectProperty<>("132%");
        ...
        public String getTrimmedText(){
            return StringTrimmer.trim(getText().trim());
        }
        public void allowMiddleLine(){
            matchText=matchText.replace("-","");
        }
        public void allowComma(){
        matchText=matchText.replace(",", "");
    }
    ...
    public void replaceSelection(String text) {
        ...
        textField.getStyleClass().removeAll("material-input",actualSize,colorActual.toString());
        //textField.setMinHeight(20);
        textField.getStyleClass().addAll("material-input",actualSize,colorActual.toString());
        mLabel.removeColor();
